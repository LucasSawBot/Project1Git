...
namespace DoallVietnam
{
    ...
    public class CutWalllouverBaseMin : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            //Level level2 = collectorLevel.OfCategory(BuiltInCategory.OST_Levels).WhereElementIsNotElementType().Cast<Level>().First(x => x.Name == "B3RD SL 82.65");
            ...
            using (Transaction tx = new Transaction(doc))
            {
                ...
                foreach (Reference rf1 in listRf1)
                {
                    ...
                    if (wall1Heigh > 2700)
                    {
                        ...
                        Wall wallLuver = Wall.Create(doc, curve1, wallTypeLuver.Id, level2.Id, (wall1Heigh - 2400) / 304.8, (2400+ wall1Offset) / 304.8, false, false);

                    }
                    else if (wall1Heigh == 2700)
                    {
                        paraWallBase1.Set((wall1Heigh) / 304.8);
